...
<div class="container emp-profile">
            ...
            <form method="post">
                ...
                <div  style="margin-right: 300px">
                        ...
                        <script> function editprofile() { location.replace("editprofile3.php");}</script>
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="profile1-tab" data-toggle="tab" href="#profile1" role="tab" aria-controls="profile1" aria-selected="true" style="font-size: 30px;color:#ED9428;font-weight:bold;background-color: rgba(255,255,255,0.5)">Personal Information</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="work-tab" data-toggle="tab" href="#work" role="tab" aria-controls="work" aria-selected="false" style="font-size: 30px;color:#ED9428;font-weight:bold;background-color: rgba(255,255,255,0.5)">Work Experience</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="education-tab" data-toggle="tab" href="#education" role="tab" aria-controls="education" aria-selected="false" style="font-size: 30px;color:#ED9428;font-weight:bold;background-color: rgba(255,255,255,0.5)">Educational Background</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="team-tab" data-toggle="tab" href="#team" role="tab" aria-controls="team" aria-selected="false" style="font-size: 30px;color:#ED9428;font-weight:bold;background-color: rgba(255,255,255,0.5)">Team Information</a>
                                 </li>     
                            </ul>
                        </div>
                    </div>

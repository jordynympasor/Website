        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Remaining Comm: <p id='demo' style="font-weight:bold;"></p>Recieved Comm: <p id='demo2' style="font-weight:bold;"></p><?php $account=$_GET['id'];
                                          $link = mysqli_connect("localhost", "id10876589_jordanus", "varela123","id10876589_login3");
                                          ...
                                          echo "<p id='demo'></p><script>var nettcp=".$row1['net_TCP'].";
                                                        ...
                                                        document.getElementById('demo').innerHTML = remainingcomm+' php';
                                                        document.getElementById('demo2').innerHTML = recievedcomm+' php';</script>
                                                        "; ?>
                    </span>
                        <h2 class="pull-left"> <?php  $account=$_GET['id'];
                                                      $link = mysqli_connect("localhost", "root", "","login3");
                                                      $query1="SELECT * FROM sale where number='$account'";
                                                      $result1=mysqli_query($link,$query1);
                                                      $row1=mysqli_fetch_array($result1);
                                                      echo $row1['client_name'];  ?>'s Voucher Details</h2>
                        <a href="superaddvoucher2.php?id=<?php echo ($_GET["id"]);?>" class="btn btn-success pull-right" style="background-color:#ED9428;border: none;color">Add New voucher</a>
                    </div>
                    ...
                    $account=$_GET['id'];
                    $sql = "SELECT * FROM voucher where ownernumber='$account'";
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<col width='80'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th style=' background:rgba(255,255,255,0.5);' onclick='sortTable(0)'>Gross Amount</th>";
                                        echo "<th style=' background:rgba(255,255,255,0.5);' onclick='sortTable(1)'>Net Commission</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td style=' background:rgba(255,255,255,0.5);'>" . $row['gross_amount'] . "</td>";
                                        echo "<td style=' background:rgba(255,255,255,0.5);'>" . $row['net_comm'] . "</td>";
                                        ...
                                        echo "<td style=' background:rgba(255,255,255,0.5);'>";
                                            echo "<a href='viewvoucheraccount2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View</a>";
                                            echo "&nbsp;";
                                            echo "<a href='editaccountvoucher2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Edit</a>";
                                            echo "&nbsp;";
                                            
                                            echo "<a href='deleteaccountvoucher2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Delete</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            

            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left"> <?php echo $_SESSION['username'];?>'s Sales Details</h2>
                    </div>
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<col width='80'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th onclick='sortTable(0)' style=' background:rgba(255,255,255,0.5);'>Client Name</th>";
                                        echo "<th onclick='sortTable(1)' style=' background:rgba(255,255,255,0.5);'>Date Reserved</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td style=' background:rgba(255,255,255,0.5);'>";
                                            echo "<a href='agentviewsales.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View sales</a>";
                                            echo "&nbsp;";
                                            echo "<a href='agentviewvoucherinfo2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View voucher</a>";
                                        echo "</td>";

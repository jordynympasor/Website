            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="testaddvoucher.php?id=<?php echo ($_GET["id"]);?>" class="btn btn-success pull-right" style="background-color:#ED9428;border: none;color">Add New voucher</a>
                    </div>
                            ...
                            echo "<col width='80'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='viewvoucheragent.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View</a>";
                                            echo "&nbsp;";
                                            echo "<a href='editagentvoucher.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Edit</a>";
                                            echo "&nbsp;";
                                            
                                            echo "<a href='deleteagentvoucher.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Delete</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            

...
<form action="createaccountphp.php" method="post" class="pure-form pure-form-aligned" style="margin-left: 500px">
    <div class="card" style="text-align: center;">
    <h2>Type</h2>
    <hr>

    <label for="checkbox-radio-option-two" class="pure-radio">
            <input id="checkbox-radio-option-two" type="radio" name="optionsRadios" value="admin" >
            Admin
        </label>
    
        <label for="checkbox-radio-option-three" class="pure-radio">
            <input id="checkbox-radio-option-three" type="radio" name="optionsRadios" value="agent" checked>
            Agent
        </label>
    ...
    <fieldset>
        ...
        <hr>
        <div class="pure-control-group">
        <label for="name" style="text-align: center ;">Team</label>
        <br>

...
<br>
<hr>
<form action="agenteditall2.php" method="post" class="pure-form pure-form-aligned" style="margin-left: 500px">
<div class="card" style="text-align: center;">
    ...
    <fieldset>
        ...
        <h5 style="margin-left: 50px">Elementary</h3>
          <div class="pure-control-group">
            <label for="name" style="text-align: center;">Name of School</label>
            <input id="name" type="text" placeholder="Name of School" name="eschool">
        </div>

        <div class="pure-control-group">
            <label for="name" style="text-align: center;">Year Graduated</label>
        ...
        <hr>
        <div class="pure-control-group">
        <label for="Team" style="text-align: center;">Team</label><br>

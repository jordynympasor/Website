...
$connect = mysqli_connect("localhost", "root", "","login3"); 
 ...
 {  
      ...
      $query = "UPDATE accounts set profile= '$file' where username='$agent';";  
...
<div class="container emp-profile">
    <div class="card2" style="margin-left: 700px">
                ...
                <?php $agent=$_GET["id"];
                                                ...
                                                $query= "SELECT * FROM accounts where username='$agent'"; 
                $result = mysqli_query($link, $query);  
                while($row = mysqli_fetch_array($result))  
                {  
                     echo '  
                            
                                    <img src="data:image/jpeg;base64,'.base64_encode($row['profile'] ).'" style="width:200px; height:200px" class="img-thumnail" name="profile image"/>  
                                
                     ';  
                }  
                ?>  
                <div class="container2">
                 <h4><b><?php $agent=$_GET["id"];
                                                $link = mysqli_connect("localhost", "root", "","login3");
                                                $query= "SELECT * FROM accounts where username='$agent'";
                                        $result = mysqli_query($link,$query);
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active card" id="profile1" role="tabpanel" aria-labelledby="profile1-tab">
                                        <div class="row">
                                            <div class="col-md-6">

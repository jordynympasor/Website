...
$query = "INSERT INTO accounts VALUES('$username2','$password','$fname','$sname','$mname','$type2','','$address','$age','$phone','$birthday','$email','$sex','$birth','$religion','$nationality','$hlurb','$prc','$valid','$pwork','$yearstay','$position','$eschool','$eyear','$hschool','$hyear','$cschool','$cyear','$team','$tlname','$ctlname','','active')";

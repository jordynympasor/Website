...
<form action="testaddvoucherphp2.php" method="POST" class="pure-form pure-form-aligned" style="margin-left: 500px">
<div class="card" style="text-align: center;">
    ...
    <fieldset>
        ...
        <div class="pure-control-group">
            ...
            <input id="name" type="text" placeholder="Net Comm" name="netcomm">
        </div>

...
<body background="logo2.jpg" style="background-repeat: no-repeat; background-size: 100%">
...
<form action="testaddsalephp.php" method="POST" class="pure-form pure-form-aligned" style="padding-left: 500px ">

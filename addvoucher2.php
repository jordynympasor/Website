...
<form action="addvoucherphp2.php" method="POST" class="pure-form pure-form-aligned" style="margin-left: 500px">
<div class="card" style="text-align: center;">
    ...
    <fieldset>
        <div class="pure-control-group">
            ...
            <input id="name" type="text" placeholder="Percent Commission" name="percent">
        </div>
        ...
        <div class="pure-control-group">
            ...
            <input id="name" type="text" placeholder="Gross Amount" name="grossamount">
        </div>

        <div class="pure-control-group">
            <label for="name">EWT</label>
            <input id="name" type="text" placeholder="EWT" name="ewt">
        </div>

        <div class="pure-control-group">
            <label for="name">Net Commission</label>
            <input id="name" type="text" placeholder="Net Commission" name="netcomm">
        </div>

        <div class="pure-control-group">
            <label for="email">Particulars</label>
            <input id="name" type="text" placeholder="Particulars" name="particulars">
        </div>

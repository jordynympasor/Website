        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    Remaining Comm: <p id='demo' style='font-weight:bold;'>><?php $account=$_GET['id'];
                        ...
                        <a href="testaddvoucher2.php?id=<?php echo ($_GET["id"]);?>" class="btn btn-success pull-right" style="background-color:#ED9428;border: none;color">Add New voucher</a>
                    </div>
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td style=' background:rgba(255,255,255,0.5);'>";
                                            echo "<a href='viewvoucheragent2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View</a>";
                                            echo "&nbsp;";
                                            echo "<a href='editagentvoucher2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Edit</a>";
                                            echo "&nbsp;";
                                            
                                            echo "<a href='deleteagentvoucher2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Delete</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            

...
<form action="editagentsalephp.php" method="POST" class="pure-form pure-form-aligned" style="margin-left: 500px">
<div class="card" style="align-content: left;">


    <h2 style="text-align: center;">Edit                            <?php $account=$_GET['id'];
    ...
    <fieldset>
        ...
        <div class="pure-control-group">
            ...
            <input class="pure-input-2-3" type="text" style="margin-left: 100px " placeholder="<?php $account=$_GET['id'];
                                        $link = mysqli_connect("localhost", "root", "","login3");
                                        $query= "SELECT * FROM sale where number='$account'";
                                        $result = mysqli_query($link,$query);
                                        $row = mysqli_fetch_array($result);

            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="addsale.php?id=<?php echo $_SESSION['username'];?>" class="btn btn-success pull-right" style="background-color:#ED9428;border: none;color">Add New Sale</a>
                    </div>
                            ...
                            echo "<col width='80'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th onclick='sortTable(1)'>Date Reserved</th>";
                                        echo "<th>Project</th>";
                                        echo "<th>Unit</th>";
                                        echo "<th></th>";
                                    echo "</tr>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='viewsales.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View</a>";
                                            echo "&nbsp;";
                                            echo "<a href='editsale.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Edit</a>";
                                            echo "&nbsp;";
                                            
                                            echo "<a href='deletesale.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>Delete</a>";
                                            echo "&nbsp;";
                                            echo "<a href='viewvoucherinfo2.php?id=". $row['number'] ."' class='btn btn-success pull-right' style='background-color:#ED9428;border: none'>View Voucher</a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            

...
<form action="createagentphp.php" method="post" class="pure-form pure-form-aligned" style="margin-left: 500px">
    <div class="card" style="text-align: center;">
    <h2>Type</h2>
    <hr>

    <label for="checkbox-radio-option-two" class="pure-radio">
            <input id="checkbox-radio-option-two" type="radio" name="optionsRadios" value="Salesperson" checked>
            Salesperson
        </label>

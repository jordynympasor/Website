<?php 
    ...
    $query= "UPDATE accounts SET status='inactive' where username='$account'";
    if (isset($_POST["yes"])) {
       mysqli_query($link,$query);
       header("location: viewagentprofile.php");
    }
?>
<!doctype html>
<html>
...
<link rel="stylesheet" href="https://unpkg.com/purecss@1.0.1/build/pure-min.css" integrity="sha384-oAOxQR6DkCoMliIh8yFnu25d7Eq/PHS21PClpwjOTeU2jRSq11vu66rf90/cZr47" crossorigin="anonymous">
    ...
    <script> function redirect() { location.replace("viewagentprofile.php");}</script>
...
<br>
<br>
<center>    <h5>Are you sure you would like to delete <?php echo ($_GET['id']);?>'s account?    </h5>
    <div>
    <style scoped>

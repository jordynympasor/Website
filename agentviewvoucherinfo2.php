                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<col width='80'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th onclick='sortTable(0)' style=' background:rgba(255,255,255,0.5);'>Gross Amount</th>";
                                        echo "<th onclick='sortTable(1)' style=' background:rgba(255,255,255,0.5);'>Net Commission</th>";
